...
| Keybinds | Ready | Nine actions bound and carried out from the settings page, stored locally as the desktop client does, and fired system-wide through a low-level keyboard hook that reports without swallowing |
