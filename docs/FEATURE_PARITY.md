...
| Favourite GIFs, stickers, emoji, and use counts | Ready | Starred in the account's `FrecencyUserSettings` blob, so they follow the account; each picker leads with what was starred |
